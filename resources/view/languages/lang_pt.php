...
$language['MAIN_HEADER_TEXT'] = 'Prepare-se para embarcar numa viagem de descoberta e paixão com aDayinDouro. Fundada em 2011 pelo visionário Manuel Guimarães, 
                um engenheiro de computação com um coração apaixonado, esta empresa familiar é muito mais do que apenas uma empresa - é uma celebração de emoções e laços familiares.
                <br><br>Prove connosco o autêntico Vale do Douro para fazer parte da Experiência mais autêntica do Douro em 2019!';
...
$language['TOURS_SECTION_TEXT'] = 'Aqui pode ver as nossas diferentes opções de passeios vínicos. De acordo com o seu perfil, personalidade e orçamento,
...
$language['ABOUT_TEXT_2'] = 'A história de Manuel e sua família ganhou vida quando, em 2019, eles foram homenageados com o prestigioso prêmio "A experiência Airbnb no Douro mais autêntica de 2019".
...
$language['ABOUT_TEXT_3'] = 'Unidos pelo amor e paixão pelo Vale do Douro, Manuel, a sua família e a sua equipa apaixonada estão prontos para compartilhar a jornada mais emocionante de sua vida.<br>
