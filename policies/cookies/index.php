    ...
    <body>
        <section class="header">
            <div class="header-container">
                <p class="header-title">Cookies Policy for aDayinDouro</p>
                <div class="header-languages">
                    <a class="header-languages-option" href="index.php">
                        <img src="../../resources/_images/languages/en.jpg" alt="English" class="language-image">
                    </a>
                    <a class="header-languages-option" href="pt_pt.php">
                        <img src="../../resources/_images/languages/pt.jpg" alt="Português" class="language-image">
                    </a>
                </div>
            </div>
        </section>
        ...
        <section class="content">
            <div class="content-container">
                <div class="content-container-text">
                    ...
                    <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can understand what type of cookies We use, or the information We collect using Cookies and how that information is used.</a>.</p>
                    ...
                    <ul>
                    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Animation4Ever, Travessa Barrosa 237 10B 4400-042.</li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                    <li><strong>Website</strong> refers to aDayinDouro, accessible from <a href="adayindouro.net" rel="external nofollow noopener" target="_blank">adayindouro.net</a></li>
                    ...
                    <ul>
                    <li>
                    <p>By email: info@adayindouro.com</p>
                    </li>
                    <li>
                    <p>By phone number: +351 916 541 852</p>
                    </li>
                    </ul>
                </div>
            </div>
