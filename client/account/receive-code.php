...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $mail->Subject = 'Alterar a sua palavra-passe!';
    $mail->Body = '<p>Aqui está o código de 6 dígitos.</p><br><p><h3>' . $code . ' </h3></p>';
...
<body class="profile">
    <div class="content">
        ...
        <div>
            ...
            <form method="POST" action="./change-password.php" onsubmit="return validateForm(event)">
