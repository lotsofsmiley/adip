...
CREATE DATABASE IF NOT EXISTS `main` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `main`;
...
INSERT INTO `employees` (`id`, `language`, `name`, `phone_number`, `email`, `img`, `text`, `role`, `family_role`, `display`, `disabled`) VALUES
	...
	(6, 1, 'Daniel', NULL, NULL, './resources/_images/member_template.jpg', 'O artista da familia, literalmente! Músico, cineasta, o homem das artes e das histórias, fofinho e bolo fofo. Os teus desejos são tudo para ele, quer seja uma caixa cheia de natinhas de manhã ou 25 copos de vinho. Gang Gang', 'Guia Turístico Sénior', 'Sobrinho do Manuel', 1, NULL),
	(6, 2, 'Daniel', NULL, NULL, './resources/_images/member_template.jpg', 'The artist of the family, literally! Musician, film-maker, the man of the arts and stories, cute and sweet, your desires are everything to him, from a box of "natas" to 25 glasses of wine. Gang Gang', 'Senior Tour Guide', 'Manuel\'s Nephew', 1, NULL),
...
-- A despejar dados para tabela main.tour: ~9 rows (aproximadamente)
DELETE FROM `tour`;
