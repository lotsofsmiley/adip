...
-- A despejar dados para tabela db.employees: ~20 rows (aproximadamente)
INSERT INTO `employees` (`id`, `language`, `name`, `phone_number`, `email`, `img`, `text`, `role`, `family_role`) VALUES
	...
	(10, 1, 'Jorge', NULL, NULL, './resources/_images/familia/jorge2/jorge2_1.jpg', 'Carinhosamente conhecido como "Jorge The Second" ou "Jorge The King", afirma que tem ligações à mais nobre realeza da cidade invicta. Jorge não é apenas um guia, ele é uma lenda viva, conhecida pelo seu título honorário e pelos seus abdominais "one pack" que são, sem dúvida, uma atração à parte! Adorador de bom vinho e boa comida. Descobre a realeza do Porto com o inigualável "Jorge The King"!', 'Guia Turístico', 'Cunhado do Sérgio'),
